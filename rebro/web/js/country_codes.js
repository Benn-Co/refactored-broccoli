...
let countries =[
   ...
   var opt = '<option class="countrycode_phone" country_code="' + countries[i].ccode + '" value="' + countries[i].value + '">' + countries[i].name + ' ('+ countries[i].mcode +')</option>';
   $("#user_countrycode_phone").append(opt);
   var country = '<option value="' + countries[i].name + '">' + countries[i].name + '</option>';
